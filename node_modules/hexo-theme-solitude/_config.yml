...
aside:
  ...
  card:
    ...
    author:
      # 头像
      # Avatar
      img: https://q1.qlogo.cn/g?b=qq&nk=1011278778&s=640
      # 表情图片链接
      # Emoticon image link
      # tip: 26x26 size
    ...
    # 背景图片
    # Background image
    background:  https://images.pexels.com/photos/1261728/pexels-photo-1261728.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2 # 不设置不会展示（仅样式为1、2时有效）
    # 文案1
    # label1
    ...
    information: # 样式为1时请不要超过4个
     Github: https://github.com/rock027r|| st-github-line # 名称：链接 || 图标 / Name: link || icon
     Bilibili: https://space.bilibili.com/357338721 || st-bilibili-line
     Wechat: https://imgos.cn/2024/08/10/66b6ea1d7f9cb.png || st-wechat-line
  ...
  newest_comment:
    ...
    limit: 100 # 评论数 / Number of comments
...
index_post_list:
  ...
  column: 2 #2:2列 3:3列
  content: true # 1: post.description / 2: 自动获取description或截取内容(Automatically get descriptions or screenshots) / 3: 只使用截取内容(Use only screenshots) / false: 不显示内容(No content is displayed)
  length: 500 # 截取内容的长度 : The length of the screenshot content
  cover: left # left: 在左侧 : left / right: 在右侧 : right / both: 两侧 : both
...
page:
  ...
  default: # 默认值 /  Default value
    # 默认图片
    # default cover
    cover: https://images.pexels.com/photos/1261728/pexels-photo-1261728.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2 # 默认图片 / default cover
